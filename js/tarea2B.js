...
countriesSelect = d3.select('#country')
...
d3.csv('dataset/covid19World.csv')
  .then(function(data) 
  {
    ...
    dataArray = data
    //dataCountries=d3.map(data, function(d){return d.country;}).keys()
    countriesSelect.append('option').attr('value','todos').text('Todos')
    console.log("1")
    countriesSelect.selectAll("option")
